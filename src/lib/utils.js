...
/* @typedef {import('../types.js').GenericIconProps} GenericIconProps */

/**
 * @public
 * @function
 * @param {GenericIconProps} props
 * @returns {GenericIconProps}
 */
export function generic_icon_props_handler({ styles = {}, ...props }) {
  const { size = '32px', color = '#333333' } = styles;
  return {
    ...props,
    css: css`
      width: ${size}px;
